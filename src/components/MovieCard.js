...
export default function MovieCard({ movie, onClick }) {
    return (
        <button className="w-full h-full p-2 sm:p-4 my-2 sm:my-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 cursor-pointer hover:bg-orange-700 hover:bg-opacity-50" onClick={onClick}>
